...
// import { ChartjsBarComponent } from './chartjs/chartjs-bar.component'; // Temporarily disabled
...
const components = [
  // ChartjsBarComponent, // Temporarily disabled - angular2-chartjs not Ivy compatible
